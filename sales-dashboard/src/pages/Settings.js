...
const DEFAULT_SETTINGS = {
    ...
    apiKey: (process.env.REACT_APP_API_KEY || 'secret-token'),
    backendUrl: (process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'),
    storeId: 1,
};
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                            ...
                            <div className="card" style={{ padding: 24 }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                                    {[
                                        { key: 'backendUrl', label: 'Backend URL', type: 'url', placeholder: (process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000') },
                                        { key: 'apiKey', label: 'API Key', type: 'password', placeholder: (process.env.REACT_APP_API_KEY || 'secret-token') },
